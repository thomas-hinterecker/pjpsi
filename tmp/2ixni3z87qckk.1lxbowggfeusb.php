        ...
        <div id="container-consent">
            <div id="consent">
                ...
                <div class="legal well">
                    ...
                    <p>
                        If you agree to be in this study, you will be asked to read inferences and assertions presented on a computer display and make judgments about them. Participation in this study will take about fifteen minutes to complete, and you will receive £1.25 for your participation. We reserve the right to reject unsatisfactory submissions (e.g., too fast responses or merely guessing).
                    </p>
                    <p>
                ...
                <center>
                    <button type="button" class="btn btn-primary btn-lg" onClick="window.location='<?php echo $BASE; ?>/exp/<?php echo $prolificid; ?>'">
