...
<html>
    <head>
		...
		<script type="text/javascript">
			...
			//var id = "<?php echo $subject['id']; ?>";  // a unique string identifying the worker/task
			var prolificid = "<?php echo $subject['prolificid']; ?>";  // a unique string identifying the worker/task
			var adServerLoc = "<?php echo $BASE; ?>";  // base path of the experiment 
			var mode = "<?php echo $mode; ?>";  // mode
			var condition = "<?php echo $subject['condition']; ?>"; // the condition number
			var counterbalance = "<?php echo $subject['counterbalance']; ?>"; // a number indexing counterbalancing conditions
		</script>
